...
// songs.shift()
// songs.push( akashadeepa,akahadallineedeepavade,appailoveyoupa );
// console.log(songs);


// code to find the length of an array
var arr=[1,2,"shivu","jyo","shanthu",3,4,5];
console.log(arr.length);

// cod to add an element at the end of an array
var arr1=arr.push("nidemma","sindhu")
console.log(arr);
...
var arr3=arr.unshift("anjali","gangu")
console.log(arr);
var arr3=arr.unshift({Hometown:"sindhanur",family:"members"})
console.log(arr);
